---
title: "knowledge-catalog-lookup-entry"
type: docs
weight: 1
description: >
  A "knowledge-catalog-lookup-entry" tool returns details of a particular entry in Knowledge Catalog.
---
...
`knowledge-catalog-lookup-entry` takes a required `name` parameter which contains the
...
|-------------|:--------:|:------------:|----------------------------------------------------|
| type        |  string  |     true     | Must be "knowledge-catalog-lookup-entry".          |

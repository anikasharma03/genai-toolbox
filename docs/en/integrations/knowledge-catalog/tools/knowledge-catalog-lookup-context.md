---
title: "knowledge-catalog-lookup-context"
type: docs
weight: 1
description: > 
  A "knowledge-catalog-lookup-context" tool provides rich metadata of one or more data assets along with their relationships.
---
...
`knowledge-catalog-lookup-context` takes a required `name` parameter which contains the
...
kind: tool
name: lookup_context
type: knowledge-catalog-lookup-context
...
|-------------|:--------:|:------------:|----------------------------------------------------|
| type        |  string  |     true     | Must be "knowledge-catalog-lookup-context".        |

...
var (
	KnowledgeCatalogSourceType                = "dataplex"
	KnowledgeCatalogLookupContextToolType     = "dataplex-lookup-context"
...
func getKnowledgeCatalogVars(t *testing.T) map[string]any {
	if KnowledgeCatalogProject == "" {
		t.Fatal("'KNOWLEDGE_CATALOG_PROJECT' or 'DATAPLEX_PROJECT' not set")
	}
...
func TestDataplexCompatibilityToolEndpoints(t *testing.T) {
